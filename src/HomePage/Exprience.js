  ...
  return (
    <div>
      <section class="exprience" id="exprience">
        <h2>
          My <span>Experiences/Skills</span>
        </h2>
          ...
          <div class="exprience-container">
            <div className="exprience-box exprience-card">
              ...
              <div className="exprience-content">
                ...
                <a href="/web-development" class="btn">
                  Read More
                </a>
              </div>
            </div>
            ...
            <div className="exprience-box exprience-card">
              ...
              <div className="exprience-content">
                ...
                <a href="/software-development" class="btn">
                  Read More
                </a>
              </div>
            </div>
            ...
            <div class="exprience-box exprience-card">
              ...
              <div className="exprience-content">
                ...
                <p>
                  {" "}
                  <Icon
                    icon="noto:man-lifting-weights"
                    width={40}
                    height={40}
                  />
                  <Icon icon="emojione:basketball" width={40} height={40} />{" "}
                  <br></br>
                  2+ years exprienced in athletic training, weightlifting,
                  olympic weightlifting. Basketball player for the school club
                  team. I train regularly for my interests and stress relief
                  also. Looking forwad to chat with you about sports and
                  recovery!
                </p>
